...
<p align="center">
  Cisco IMM Automation Tools is a growing collection of software for automating the build and deployment of Cisco UCS Pools, Policies, and Profiles on Cisco Intersight for UCS X-Series hardware and previous generation UCS systems. The automation of Intersight Managed Mode is simpliflied with easy to use tools requiring minimal programming knowledge.
</p>
<br>
