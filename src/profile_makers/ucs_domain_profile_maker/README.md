<h1 align="center">Base UCS Domain Profile Maker</h1>
...
<p align="center">
  The Base UCS Domain Profile Maker for Cisco Intersight automates the creation of base UCS Domain Profiles without Policies.
</p>
<br>

## Features
- Automatically build an Intersight base UCS Domain Profile without Policies to your exact specification. Anything that can be done through the Intersight GUI can be done here and more!
...
## Where to Demo
The Base UCS Domain Profile Maker can be demoed on Cisco dCloud in the following content:
...
1. [**_Getting Started with Cisco Intersight v2_**](https://dcloud2-rtp.cisco.com/content/instantdemo/getting-started-with-cisco-intersight-v2)
    - **`NOTE:`** Before running the Base UCS Domain Profile Maker, change the Pool organization to "Sandpit".
