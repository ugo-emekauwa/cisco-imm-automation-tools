"""
UCS Server Profile Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The UCS Server Profile Maker for Cisco Intersight automates the
         creation of UCS Server Profiles.
...
# General Settings
ucs_server_profile_name = "UCS-Server-Profile-1"
ucs_server_profile_description = "A Cisco Intersight UCS Server Profile generated by the UCS Server Profile Maker."
...
# UCS Server Assignment Settings
...
## Here is an example using the Server user label: ucs_server_assignment_identifier = "Sample_User_Label"
## Leave the ucs_server_assignment_identifier variable as an empty string ("") if using the Resource Pool assignment option in the next section.
ucs_server_assignment_identifier = ""
ucs_server_form_factor = "Blade"        # Options: "Blade", "Rack"

## NOTE - Assignment to a Resource Pool
## For the Resource Pool assignment identifier variable, the accepted value is the Resource Pool name only.
## Any value provided for the ucs_server_assignment_identifier variable in the previous section will take precedence over any Resource Pool provided.
...
def main():
    ...
    maker_type = "Intersight UCS Server Profile Maker"
    ...
    if assign_ucs_server_profile:
        assign_and_deploy_ucs_server_profile(
            ...
            ucs_server_assignment_identifier=ucs_server_assignment_identifier,
            ucs_server_form_factor=ucs_server_form_factor,
            ucs_server_type=ucs_server_type,
