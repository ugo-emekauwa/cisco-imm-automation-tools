...
2. Within the unzipped Cisco IMM Automation Tools repository, navigate to the folder \src\pool_makers\mac_pool_maker.
3. Edit the mac_pool_maker.py file to set the **`key_id`** variable using the following instructions:
    ...
    **(d).** Fill in between the quotes of the **`key_id`** variable value with the ID of your API key. For example:
      ...
      ```
4. Edit the mac_pool_maker.py file to set the **`key`** variable using the following instructions:
    ...
    **(d).** Fill in between the quotes of the **`key`** variable value with your system's file path to the SecretKey.txt file for your API key. For example:
      ...
      ```
5. Edit the mac_pool_maker.py file to set all the configuration variable values using the following instructions:
...
6. Save the changes you have made to the mac_pool_maker.py file.
7. Run the mac_pool_maker.py file.

## Where to Demo
The MAC Pool Maker can be demoed on Cisco dCloud in the following soon to be released content:
