"""
WWPN Pool Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The WWPN Pool Maker for Cisco Intersight automates the creation
         of WWPN Pools.
...
WWPN Pool on Cisco Intersight. Remove the sample
...
wwpn_pool_description = "A Cisco Intersight WWPN Pool generated by the WWPN Pool Maker."
wwpn_pool_organization = "default"
...
wwpn_assignment_order = "default"       # Options: "default", "sequential"
...
def wwpn_pool_maker(intersight_api_key_id,
                    intersight_api_key,
                    pool_name,
                    wwpn_blocks_list=None,
                    pool_description="",
    ...
    builder(WwpnPool(intersight_api_key_id=intersight_api_key_id,
...
def main():
    ...
    maker_type = "Intersight WWPN Pool Maker"
    ...
    wwpn_pool_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        pool_name=wwpn_pool_name,
        wwpn_blocks_list=wwpn_blocks_list,
        pool_description=wwpn_pool_description,
        pool_assignment_order=wwpn_assignment_order,
        organization=wwpn_pool_organization,
        tags=wwpn_pool_tags,
        preconfigured_api_client=main_intersight_api_client
        )
