"""
WWNN Pool Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The WWNN Pool Maker for Cisco Intersight automates the creation
         of WWNN Pools.
...
WWNN Pool on Cisco Intersight. Remove the sample
...
wwnn_pool_description = "A Cisco Intersight WWNN Pool generated by the WWNN Pool Maker."
wwnn_pool_organization = "default"
...
wwnn_assignment_order = "default"       # Options: "default", "sequential"
...
def main():
    ...
    maker_type = "Intersight WWNN Pool Maker"
    ...
    wwnn_pool_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        pool_name=wwnn_pool_name,
        wwnn_blocks_list=wwnn_blocks_list,
        pool_description=wwnn_pool_description,
        pool_assignment_order=wwnn_assignment_order,
        organization=wwnn_pool_organization,
        tags=wwnn_pool_tags,
        preconfigured_api_client=main_intersight_api_client
        )
