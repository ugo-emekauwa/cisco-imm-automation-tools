"""
IP Pool Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The IP Pool Maker for Cisco Intersight automates the creation
         of IP Pools.
...
IP Pool on Cisco Intersight. Remove the sample
...
# General Settings
ip_pool_name = "IP-Pool-1"
ip_pool_description = "A Cisco Intersight IP Pool generated by the IP Pool Maker."
ip_pool_organization = "default"
ip_pool_tags = {"Org": "IT", "Dept": "DevOps"}  # Empty the ip_pool_tags dictionary if no tags are needed, for example: ip_pool_tags = {}

# Pool Detail Settings
configure_ipv4_pool = True
ipv4_netmask = "255.255.255.0"
ipv4_gateway = "192.168.0.1"
ipv4_primary_dns = "192.168.133.1"
ipv4_secondary_dns = ""
...
ip_assignment_order = "default"       # Options: "default", "sequential"
...
def main():
    ...
    maker_type = "Intersight IP Pool Maker"
    ...
    ip_pool_maker(
        ...
        ipv6_secondary_dns=ipv6_secondary_dns,
        ipv6_blocks_list=ipv6_blocks_list,
        pool_description=ip_pool_description,
        pool_assignment_order=ip_assignment_order,
        organization=ip_pool_organization,
        intersight_base_url=intersight_base_url,
        tags=ip_pool_tags,
        preconfigured_api_client=main_intersight_api_client
        )
