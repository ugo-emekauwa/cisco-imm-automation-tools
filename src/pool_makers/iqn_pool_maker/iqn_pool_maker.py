"""
IQN Pool Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The IQN Pool Maker for Cisco Intersight automates the creation
         of IQN Pools.
...
IQN Pool on Cisco Intersight. Remove the sample
...
iqn_pool_description = "A Cisco Intersight IQN Pool generated by the IQN Pool Maker."
iqn_pool_organization = "default"
...
iqn_blocks_list = [
    {"Suffix": "ucs.windows.host", "From": 1, "Size": 256},
    {"Suffix": "ucs.linux.host", "From": 1, "Size": 256},
    ]

# Pool Default Settings (Change only if needed)
iqn_assignment_order = "default"       # Options: "default", "sequential"
...
def iqn_pool_maker(intersight_api_key_id,
                   intersight_api_key,
                   pool_name,
                   iqn_blocks_list=None,
                   iqn_prefix="iqn.1987-05.com.cisco",
...
def main():
    ...
    maker_type = "Intersight IQN Pool Maker"
    ...
    iqn_pool_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        pool_name=iqn_pool_name,
        iqn_blocks_list=iqn_blocks_list,
        iqn_prefix=iqn_prefix,
        pool_description=iqn_pool_description,
        pool_assignment_order=iqn_assignment_order,
        organization=iqn_pool_organization,
        tags=iqn_pool_tags,
        preconfigured_api_client=main_intersight_api_client
        )
