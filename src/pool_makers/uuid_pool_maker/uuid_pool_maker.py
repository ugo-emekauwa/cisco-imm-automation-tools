"""
UUID Pool Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The UUID Pool Maker for Cisco Intersight automates the creation
         of UUID Pools.
...
UUID Pool on Cisco Intersight. Remove the sample
...
uuid_pool_description = "A Cisco Intersight UUID Pool generated by the UUID Pool Maker."
uuid_pool_organization = "default"
...
uuid_assignment_order = "default"       # Options: "default", "sequential"
...
def main():
    ...
    maker_type = "Intersight UUID Pool Maker"
    ...
    uuid_pool_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        pool_name=uuid_pool_name,
        uuid_blocks_list=uuid_blocks_list,
        uuid_prefix=uuid_prefix,
        pool_description=uuid_pool_description,
        pool_assignment_order=uuid_assignment_order,
        organization=uuid_pool_organization,
        intersight_base_url=intersight_base_url,
        tags=uuid_pool_tags,
        preconfigured_api_client=main_intersight_api_client
        )
