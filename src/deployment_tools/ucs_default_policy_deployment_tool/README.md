<h1 align="center">UCS Default Policy Deployment Tool</h1>
...
<br>
<p align="center">
  The UCS Default Policy Deployment Tool for Cisco Intersight automates the comprehensive build and deployment of default UCS Policies for Cisco IMM (Intersight Managed Mode).
</p>
<br>
...
2. Within the unzipped Cisco IMM Automation Tools repository, navigate to the folder \src\deployment_tools\ucs_default_policy_deployment_tool.
3. Edit the ucs_default_policy_deployment_tool.py file to set the **`key_id`** variable using the following instructions:

    **(a).** Open the ucs_default_policy_deployment_tool.py file in an IDLE or text editor of choice.
    ...
    **(d).** Fill in between the quotes of the **`key_id`** variable value with the ID of your API key. For example:
      ...
      ```
4. Edit the ucs_default_policy_deployment_tool.py file to set the **`key`** variable using the following instructions:
    ...
    **(d).** Fill in between the quotes of the **`key`** variable value with your system's file path to the SecretKey.txt file for your API key. For example:
      ...
      ```
5. Edit the ucs_default_policy_deployment_tool.py file to set all the configuration variable values using the following instructions:
...
6. Save the changes you have made to the ucs_default_policy_deployment_tool.py file.
7. Run the ucs_default_policy_deployment_tool.py file.

## Where to Demo
The UCS Default Policy Deployment Tool can be demoed on Cisco dCloud in the following content:
