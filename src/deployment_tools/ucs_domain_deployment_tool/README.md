...
<h1 align="center">
  <img alt="Deployment Tools Title Image" title="Deployment Tools" src="./ucs_domain_deployment_tool/assets/Deployment_Tools_Title_Graphic.png">
</h1>  
...
3. [_Optional_] If you already have the Cisco Intersight SDK for Python installed, you may need to upgrade. An upgrade can be performed by running the following command:
   ...
   ```
4. Clone or download the Cisco IMM Automation Tools repository by using the ![GitHub Code Button](./ucs_domain_deployment_tool/assets/GitHub_Code_Button.png "GitHub Code Button") link on the main repository web page or by running the following command:
    ```
...
5. Generate a version 2 API key from your Intersight account.
    ...
    **(a).** Log into your Intersight account, click the Settings icon and select **Settings**.
      ...
      ![Figure 1 - Go to Settings](./ucs_domain_deployment_tool/assets/Figure_1_Go_to_Settings.png "Figure 1 - Go to Settings")
      
    **(b).** Under the API section in the work pane, click **API Keys**.
    
      ![Figure 2 - Go to API Keys](./ucs_domain_deployment_tool/assets/Figure_2_Go_to_API_Keys.png "Figure 2 - Go to API Keys")
      
    **(c).** In the API Keys section in the work pane, click the **Generate API Key** button.
    
      ![Figure 3 - Click the Generate API Key button](./ucs_domain_deployment_tool/assets/Figure_3_Click_the_Generate_API_Key_button.png "Figure 3 - Click the Generate API Key button")
      
    **(d).** In the Generate API Key window, enter a description or name for your API key.
    
      ![Figure 4 - Enter an API key description](./ucs_domain_deployment_tool/assets/Figure_4_Enter_an_API_key_description.png "Figure 4 - Enter an API key description")
      
    **(e).** In the Generate API Key window, under API Key Purpose, verify a version 2 API key is selected.
    
      ![Figure 5 - Verify version 2 API key selection](./ucs_domain_deployment_tool/assets/Figure_5_Verify_version_2_API_key_selection.png "Figure 5 - Verify version 2 API key selection")
      
    **(f).** In the Generate API Key window, click the **Generate** button.
    
      ![Figure 6 - Click the Generate button](./ucs_domain_deployment_tool/assets/Figure_6_Click_the_Generate_button.png "Figure 6 - Click the Generate button")
    ...
    **(g).** In the Generate API Key window, a new API key will be generated. Copy the API Key ID and download the Secret Key to a secure location.
      ...
      ![Figure 7 - Copy and save the API key data](./ucs_domain_deployment_tool/assets/Figure_7_Copy_and_save_the_API_key_data.png "Figure 7 - Copy and save the API key data")
...
2. Edit the ucs_domain_deployment_tool.py file to set the **`key_id`** variable using the following instructions:

    **(a).** Open the ucs_domain_deployment_tool.py file in an IDLE or text editor of choice.
    
    **(b).** Find the comment **`# MODULE REQUIREMENT 1 #`**.
     
      ![Figure 9 - MODULE REQUIREMENT 1 location](./ucs_domain_deployment_tool/assets/Figure_9_MODULE_REQUIREMENT_1_location.png "Figure 9 - MODULE REQUIREMENT 1 location")
      
    **(c).** Underneath, you will find the variable **`key_id`**. The variable is currently empty.
    
      ![Figure 10 - key_id variable location](./ucs_domain_deployment_tool/assets/Figure_10_key_id_variable_location.png "Figure 10 - key_id variable location")
...
3. Edit the ucs_domain_deployment_tool.py file to set the **`key`** variable using the following instructions:
    ...
    **(b).** Find the comment **`# MODULE REQUIREMENT 2 #`**.
      ...
      ![Figure 11 - MODULE REQUIREMENT 2 location](./ucs_domain_deployment_tool/assets/Figure_11_MODULE_REQUIREMENT_2_location.png "Figure 11 - MODULE REQUIREMENT 2 location")
      
    **(c).** Underneath, you will find the variable **`key`**. The variable is currently empty.
    
      ![Figure 12 - key variable location](./ucs_domain_deployment_tool/assets/Figure_12_key_variable_location.png "Figure 12 - key variable location")
...
4. Edit the ucs_domain_deployment_tool.py file to set all the configuration variable values using the following instructions:
    ...
    **(b).** Find the comment **`# MODULE REQUIREMENT 3 #`**.
      ...
      ![Figure 13 - MODULE REQUIREMENT 3 location](./ucs_domain_deployment_tool/assets/Figure_13_MODULE_REQUIREMENT_3_location.png "Figure 13 - MODULE REQUIREMENT 3 location")
    ...
    **(c).** Underneath, you will find the instructions to edit the configuration variable values to match your environment. Each variable has a sample value for ease of use. The variable values to edit begin under the comment **`####### Start Configuration Settings - Provide values for the variables listed below. #######`**.
      ...
      ![Figure 14 - Start Configuration Settings location](./ucs_domain_deployment_tool/assets/Figure_14_Start_Configuration_Settings_location.png "Figure 14 - Start Configuration Settings location")
    ...
    Completion of editing the configuration variable values is marked by the comment **`####### Finish Configuration Settings - The required value entries are complete. #######`**.
      ...
      ![Figure 15 - Finish Configuration Settings location](./ucs_domain_deployment_tool/assets/Figure_15_Finish_Configuration_Settings_location.png "Figure 15 - Finish Configuration Settings location")
...
1. [**_Getting Started with Cisco Intersight v2_**](https://dcloud2-rtp.cisco.com/content/instantdemo/getting-started-with-cisco-intersight-v2)
    - **`NOTE:`** Change the UCS domain profile organization to "Sandpit" in the UCS Domain Deployment Tool.
2. **_Cisco UCS X-Series with Intersight (Instant Demo)_** - Coming soon!
3. **_Cisco UCS X-Series with Intersight Lab (Scheduled Demo/Sandbox)_** - Coming soon!
