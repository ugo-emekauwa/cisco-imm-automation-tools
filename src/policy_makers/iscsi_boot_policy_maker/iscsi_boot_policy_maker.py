"""
iSCSI Boot Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The iSCSI Boot Policy Maker for Cisco Intersight automates the
         creation of iSCSI Boot Policies.
...
iSCSI Boot Policy on Cisco Intersight. Remove the sample
...
iscsi_boot_policy_description = "A Cisco Intersight iSCSI Boot Policy generated by the iSCSI Boot Policy Maker."
iscsi_boot_policy_organization = "default"
...
static_initiator_ip_source = "Static"        # Options: "Pool", "DHCP", or "Static"
static_initiator_ip_source_pool_ip_pool_name = ""
static_initiator_ip_source_static_ip_address = "192.168.2.101"
static_initiator_ip_source_static_subnet_mask = "255.255.255.0"
static_initiator_ip_source_static_default_gateway = "192.168.2.1"
static_initiator_ip_source_static_primary_dns = "192.168.2.10"
static_initiator_ip_source_static_secondary_dns = "192.168.2.11"
...
def main():
    ...
    maker_type = "Intersight iSCSI Boot Policy Maker"
    ...
    iscsi_boot_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=iscsi_boot_policy_name,
        iscsi_adapter_policy_name=iscsi_adapter_policy_name,
        configuration_type_for_target_source=configuration_type_for_target_source,
        auto_target_dhcp_vendor_id_or_iqn=auto_target_dhcp_vendor_id_or_iqn,
        static_primary_target_policy_name=static_primary_target_policy_name,
        ...
        organization=iscsi_boot_policy_organization,
        intersight_base_url=intersight_base_url,
