"""
Link Aggregation Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Link Aggregation Policy Maker for Cisco Intersight automates
         the creation of Link Aggregation Policies.
...
Link Aggregation Policy on Cisco Intersight. Remove the sample
...
link_aggregation_policy_description = "A Cisco Intersight Link Aggregation Policy generated by the Link Aggregation Policy Maker."
link_aggregation_policy_organization = "default"
...
lacp_rate = "Normal"        # Options: "Normal", "Fast"
...
def main():
    ...
    maker_type = "Intersight Link Aggregation Policy Maker"
    ...
    link_aggregation_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=link_aggregation_policy_name,
        suspend_individual=suspend_individual,
        lacp_rate=lacp_rate,
