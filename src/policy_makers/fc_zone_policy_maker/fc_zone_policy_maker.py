"""
FC Zone Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The FC Zone Policy Maker for Cisco Intersight automates the creation
         of FC Zone Policies in Intersight.
...
FC Zone Policy on Cisco Intersight. Remove the sample
...
fc_zone_policy_description = "A Cisco Intersight FC Zone Policy generated by the FC Zone Policy Maker."
fc_zone_policy_organization = "default"
...
fc_target_zoning_type = "Single Initiator Single Target"        # Options: "Single Initiator Single Target", "Single Initiator Multiple Target", "None"
fc_zone_target_list = [
...
def main():
    ...
    maker_type = "Intersight FC Zone Policy Maker"
    ...
    fc_zone_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=fc_zone_policy_name,
        fc_target_zoning_type=fc_target_zoning_type,
        fc_zone_target_list=fc_zone_target_list,
        policy_description=fc_zone_policy_description,
        organization=fc_zone_policy_organization,
        intersight_base_url=intersight_base_url,
