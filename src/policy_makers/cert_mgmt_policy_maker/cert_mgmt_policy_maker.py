"""
Certificate Management Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Certificate Management Policy Maker for Cisco Intersight automates the creation
...
Certificate Management Policy on Cisco Intersight. Remove the sample
...
cert_mgmt_policy_organization = "default"
...
def main():
    ...
    maker_type = "Intersight Certificate Management Policy Maker"
    ...
    cert_mgmt_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=cert_mgmt_policy_name,
        certificate=certificate,
        private_key=private_key,
        enable_imc_certificate=enable_imc_certificate,
        policy_description=cert_mgmt_policy_description,
        organization=cert_mgmt_policy_organization,
        intersight_base_url=intersight_base_url,
