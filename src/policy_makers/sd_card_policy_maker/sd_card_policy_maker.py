"""
SD Card Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The SD Card Policy Maker for Cisco Intersight automates the
         creation of SD Card Policies.
...
SD Card Policy on Cisco Intersight. Remove the sample
...
sd_card_policy_description = "A Cisco Intersight SD Card Policy generated by the SD Card Policy Maker."
sd_card_policy_organization = "default"
...
sd_card_mode = "Operating System Only"      # Options: "Operating System Only", "Utility Only", "Operating System + Utility"
...
def main():
    ...
    maker_type = "Intersight SD Card Policy Maker"
    ...
    sd_card_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=sd_card_policy_name,
        sd_card_mode=sd_card_mode,
        enable_operating_system=enable_operating_system,
        operating_system_partition_name=operating_system_partition_name,
        enable_utility_diagnostics=enable_utility_diagnostics,
        ...
        organization=sd_card_policy_organization,
        intersight_base_url=intersight_base_url,
