"""
iSCSI Static Target Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The iSCSI Static Target Policy Maker for Cisco Intersight automates the
         creation of iSCSI Static Target Policies.
...
iSCSI Static Target Policy on Cisco Intersight. Remove the sample
...
# General Settings
iscsi_static_target_policy_name = "iSCSI-Static-Target-Policy-1"
iscsi_static_target_policy_description = "A Cisco Intersight iSCSI Static Target Policy generated by the iSCSI Static Target Policy Maker."
iscsi_static_target_policy_organization = "default"
iscsi_static_target_policy_tags = {"Org": "IT", "Dept": "DevOps"}  # Empty the iscsi_static_target_policy_tags dictionary if no tags are needed, for example: iscsi_static_target_policy_tags = {}

# Policy Detail Settings
target_name = "iqn.1987-05.com.cisco:netapp:sn.343777525"
ip_address = "192.168.7.100"
port = 3260      # Options: 1 - 65535
lun_id = 0
...
def main():
    ...
    maker_type = "Intersight iSCSI Static Target Policy Maker"
    ...
    iscsi_static_target_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=iscsi_static_target_policy_name,
        target_name=target_name,
        ip_address=ip_address,
        port=port,
        lun_id=lun_id,
        lun_is_bootable=lun_is_bootable,
        policy_description=iscsi_static_target_policy_description,
        organization=iscsi_static_target_policy_organization,
        intersight_base_url=intersight_base_url,
        tags=iscsi_static_target_policy_tags,
        preconfigured_api_client=main_intersight_api_client
        )
