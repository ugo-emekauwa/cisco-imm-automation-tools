"""
Ethernet Network Group Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Ethernet Network Group Policy Maker for Cisco Intersight automates
         the creation of Ethernet Network Group Policies.
...
Ethernet Network Group Policy on Cisco Intersight. Remove the sample
...
ethernet_network_group_policy_description = "A Cisco Intersight Ethernet Network Group Policy generated by the Ethernet Network Group Policy Maker."
ethernet_network_group_policy_organization = "default"
...
def main():
    ...
    maker_type = "Intersight Ethernet Network Group Policy Maker"
    ...
    ethernet_network_group_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=ethernet_network_group_policy_name,
        allowed_vlans=allowed_vlans,
        native_vlan=native_vlan,
