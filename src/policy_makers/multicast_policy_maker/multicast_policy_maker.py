"""
Multicast Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Multicast Policy Maker for Cisco Intersight automates the
         creation of Multicast Policies.
...
Multicast Policy on Cisco Intersight. Remove the sample
...
multicast_policy_description = "A Cisco Intersight Multicast Policy generated by the Multicast Policy Maker."
multicast_policy_organization = "default"
...
snooping_state = "Enabled"      # Options: "Enabled", "Disabled"
querier_state = "Disabled"      # Options: "Enabled", "Disabled"
querier_ip_address = ""
...
def main():
    ...
    maker_type = "Intersight Multicast Policy Maker"
    ...
    multicast_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=multicast_policy_name,
        snooping_state=snooping_state,
        querier_state=querier_state,
        querier_ip_address=querier_ip_address,
        querier_ip_address_peer=querier_ip_address_peer,
        policy_description=multicast_policy_description,
        organization=multicast_policy_organization,
