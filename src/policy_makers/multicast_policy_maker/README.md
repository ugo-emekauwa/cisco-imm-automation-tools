<h1 align="center">Multicast Policy Maker</h1>
...
<p align="center">
  The Multicast Policy Maker for Cisco Intersight automates the creation of Multicast Policies.
</p>
<br>

## Features
- Automatically build an Intersight Multicast Policy to your exact specification. Anything that can be done through the Intersight GUI can be done here and more!

- Quickly restore Multicast Policy configurations as part of your on-prem Intersight backup solution.
...
## Where to Demo
The Multicast Policy Maker can be demoed on Cisco dCloud in the following content:
...
1. [**_Getting Started with Cisco Intersight v2_**](https://dcloud2-rtp.cisco.com/content/instantdemo/getting-started-with-cisco-intersight-v2)
    - **`NOTE:`** Before running the Multicast Policy Maker, change the Policy organization to "Sandpit".
