"""
Flow Control Policy Maker for Cisco Intersight, v1.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Flow Control Policy Maker for Cisco Intersight automates
         the creation of Flow Control Policies.
...
Flow Control Policy on Cisco Intersight. Remove the sample
...
flow_control_policy_description = "A Cisco Intersight Flow Control Policy generated by the Flow Control Policy Maker."
flow_control_policy_organization = "default"
...
priority = "Auto"       # Options: "Auto", "On"
receive = "Disabled"        # Options: "Enabled", "Disabled"
send = "Disabled"       # Options: "Enabled", "Disabled"
...
def main():
    ...
    maker_type = "Intersight Flow Control Policy Maker"
    ...
    flow_control_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=flow_control_policy_name,
        priority=priority,
        receive=receive,
        send=send,
