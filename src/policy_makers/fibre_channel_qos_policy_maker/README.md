<h1 align="center">Fibre Channel QoS Policy Maker</h1>
...
<br>
<p align="center">
  The Fibre Channel QoS Policy Maker for Cisco Intersight automates the creation of Fibre Channel QoS Policies.
</p>
<br>

## Features
- Automatically build an Intersight Fibre Channel QoS Policy to your exact specification. Anything that can be done through the Intersight GUI can be done here and more!

- Automatically attach the Fibre Channel QoS Policy to a UCS Domain Profile if desired, during the Fibre Channel QoS Policy configuration.

- Quickly restore Fibre Channel QoS Policy configurations as part of your on-prem Intersight backup solution.
...
2. Within the unzipped Cisco IMM Automation Tools repository, navigate to the folder \src\policy_makers\fibre_channel_qos_policy_maker.
3. Edit the fibre_channel_qos_policy_maker.py file to set the **`key_id`** variable using the following instructions:

    **(a).** Open the fibre_channel_qos_policy_maker.py file in an IDLE or text editor of choice.
    ...
    **(d).** Fill in between the quotes of the **`key_id`** variable value with the ID of your API key. For example:
      ...
      ```
4. Edit the fibre_channel_qos_policy_maker.py file to set the **`key`** variable using the following instructions:
    ...
    **(d).** Fill in between the quotes of the **`key`** variable value with your system's file path to the SecretKey.txt file for your API key. For example:
      ...
      ```
5. Edit the fibre_channel_qos_policy_maker.py file to set all the configuration variable values using the following instructions:
...
6. Save the changes you have made to the fibre_channel_qos_policy_maker.py file.
7. Run the fibre_channel_qos_policy_maker.py file.

## Where to Demo
The Fibre Channel QoS Policy Maker can be demoed on Cisco dCloud in the following content:
