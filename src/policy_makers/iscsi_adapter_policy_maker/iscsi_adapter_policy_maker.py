"""
iSCSI Adapter Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The iSCSI Adapter Policy Maker for Cisco Intersight automates the
         creation of iSCSI Adapter Policies.
...
iSCSI Adapter Policy on Cisco Intersight. Remove the sample
...
iscsi_adapter_policy_organization = "default"
...
tcp_connection_timeout = 15        # Options: 0 - 255
dhcp_timeout = 60      # Options: 60 - 300
lun_busy_retry_count = 15      # Options: 0 - 60
...
def main():
    ...
    maker_type = "Intersight iSCSI Adapter Policy Maker"
    ...
    iscsi_adapter_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=iscsi_adapter_policy_name,
        tcp_connection_timeout=tcp_connection_timeout,
        dhcp_timeout=dhcp_timeout,
        lun_busy_retry_count=lun_busy_retry_count,
        policy_description=iscsi_adapter_policy_description,
        organization=iscsi_adapter_policy_organization,
        intersight_base_url=intersight_base_url,
