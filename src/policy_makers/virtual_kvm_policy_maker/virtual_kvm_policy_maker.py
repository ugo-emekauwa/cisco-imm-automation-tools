...
Summary: The Virtual KVM Policy Maker for Cisco Intersight automates the
         creation of Virtual KVM Policies.
...
Virtual KVM Policy on Cisco Intersight. Remove the sample
...
virtual_kvm_policy_organization = "default"
...
max_sessions = 4        # Options: 1 - 4
remote_port = 2068      # Options: 1 - 65535
...
def main():
    ...
    virtual_kvm_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=virtual_kvm_policy_name,
        enable_virtual_kvm=enable_virtual_kvm,
        max_sessions=max_sessions,
        remote_port=remote_port,
        enable_video_encryption=enable_video_encryption,
