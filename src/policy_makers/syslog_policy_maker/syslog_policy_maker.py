"""
Syslog Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Syslog Policy Maker for Cisco Intersight automates the creation
         of Syslog Policies in Intersight.
...
Syslog Policy on Cisco Intersight. Remove the sample
...
syslog_policy_description = "A Cisco Intersight Syslog Policy generated by the Syslog Policy Maker."
syslog_policy_organization = "default"
...
syslog_local_logging_minimum_severity_to_report = "warning"     # Options: "warning", "emergency", "alert", "critical", "error", "notice", "informational", "debug"
syslog_remote_logging_server_list = [
    {"Enable": True,
...
def main():
    ...
    maker_type = "Intersight Syslog Policy Maker"
    ...
    syslog_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=syslog_policy_name,
        syslog_local_logging_minimum_severity_to_report=syslog_local_logging_minimum_severity_to_report,
        syslog_remote_logging_server_list=syslog_remote_logging_server_list,
