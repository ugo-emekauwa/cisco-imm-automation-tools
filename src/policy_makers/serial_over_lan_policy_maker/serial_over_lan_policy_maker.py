"""
Serial Over LAN Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Serial Over LAN Policy Maker for Cisco Intersight automates the
         creation of Serial Over LAN Policies.
...
Serial Over LAN Policy on Cisco Intersight. Remove the sample
...
serial_over_lan_policy_organization = "default"
...
com_port = "com0"        # Options: "com0" or "com1"
baud_rate = 9600        # Options: 9600, 19200, 38400, 57600, 115200
ssh_port = 2400        # Options: 1024 - 65535
...
def main():
    ...
    maker_type = "Intersight Serial Over LAN Policy Maker"
    ...
    serial_over_lan_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=serial_over_lan_policy_name,
        enable_serial_over_lan=enable_serial_over_lan,
        com_port=com_port,
        baud_rate=baud_rate,
        ssh_port=ssh_port,
        policy_description=serial_over_lan_policy_description,
        organization=serial_over_lan_policy_organization,
        intersight_base_url=intersight_base_url,
