"""
Fibre Channel Adapter Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Fibre Channel Adapter Policy Maker for Cisco Intersight
         automates the creation of Fibre Channel Adapter Policies.
...
Fibre Channel Adapter Policy on Cisco Intersight. Remove the sample
...
fibre_channel_adapter_policy_organization = "default"
...
port_down_timeout_in_ms = 10000     # Options: 0 - 240000
link_down_timeout_in_ms = 30000     # Options: 0 - 240000
io_retry_timeout_in_seconds = 5     # Options: 1 - 59
port_down_io_retry_in_ms = 8        # Options: 0 - 255

## Error Detection
error_detection_timeout = 2000  # Options: 1000 - 100000

## Resource Allocation
resource_allocation_timeout = 10000     # Options: 5000 - 100000

## Flogi
flogi_retries = 8       # Options: > 0
flogi_timeout_in_ms = 4000      # Options: 1000 - 255000

## Plogi
plogi_retries = 8       # Options: 0 - 255
plogi_timeout_in_ms = 20000     # Options: 1000 - 255000

## Interrupt
interrupt_mode = "MSIx"     # Options: "MSIx", "MSI", or "INTx"

## I/O Throttle
io_throttle_count = 512     # Options: 1 - 1024

## LUN
maximum_luns_per_target = 1024     # Options: 1 - 1024
lun_queue_depth = 20     # Options: 1 - 254

## Receive Settings
receive_ring_size = 64        # Options: > 64

## Transmit Settings
transmit_ring_size = 64        # Options: > 64

## SCSI I/O
scsi_io_queues = 1     # Options: 1 - 245
scsi_io_ring_size = 512     # Options: 64 - 512
...
def main():
    ...
    maker_type = "Intersight Fibre Channel Adapter Policy Maker"
    ...
    fibre_channel_adapter_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=fibre_channel_adapter_policy_name,
        fibre_channel_adapter_default_configuration=fibre_channel_adapter_default_configuration,
        fcp_error_recovery=fcp_error_recovery,
        port_down_timeout_in_ms=port_down_timeout_in_ms,
        link_down_timeout_in_ms=link_down_timeout_in_ms,
        ...
        organization=fibre_channel_adapter_policy_organization,
        intersight_base_url=intersight_base_url,
