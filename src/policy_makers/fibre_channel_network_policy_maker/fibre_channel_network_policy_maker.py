"""
Fibre Channel Network Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Fibre Channel Network Policy Maker for Cisco Intersight automates
         the creation of Fibre Channel Network Policies.
...
Fibre Channel Network Policy on Cisco Intersight. Remove the sample
...
fibre_channel_network_policy_organization = "default"
...
def main():
    ...
    maker_type = "Intersight Fibre Channel Network Policy Maker"
    ...
    fibre_channel_network_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=fibre_channel_network_policy_name,
        default_vlan=default_vlan,
        vsan_id=vsan_id,
        policy_description=fibre_channel_network_policy_description,
        organization=fibre_channel_network_policy_organization,
