"""
Ethernet QoS Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Ethernet QoS Policy Maker for Cisco Intersight automates
         the creation of Ethernet QoS Policies.
...
Ethernet QoS Policy on Cisco Intersight. Remove the sample
...
ethernet_qos_policy_organization = "default"
...
ethernet_qos_mtu_in_bytes = 1500        # Options: 1500 - 9000
ethernet_qos_rate_limit_in_mbps = 0        # Options: 0 - 100000
ethernet_qos_cos = 3        # Options: 0 - 6
ethernet_qos_burst = 1024        # Options: 1024 - 1000000
ethernet_qos_priority = "Best Effort"        # Options: "Best Effort", "FC", "Platinum", "Gold", "Silver", "Bronze"
ethernet_qos_enable_trust_host_cos = False        # Options: True, False
...
def main():
    ...
    maker_type = "Intersight Ethernet QoS Policy Maker"
    ...
    ethernet_qos_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=ethernet_qos_policy_name,
        ethernet_qos_mtu_in_bytes=ethernet_qos_mtu_in_bytes,
        ethernet_qos_rate_limit_in_mbps=ethernet_qos_rate_limit_in_mbps,
        ethernet_qos_cos=ethernet_qos_cos,
        ethernet_qos_burst=ethernet_qos_burst,
        ...
        organization=ethernet_qos_policy_organization,
