"""
Virtual Media Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Virtual Media Policy Maker for Cisco Intersight automates the creation
         of Virtual Media Policies in Intersight.
...
Virtual Media Policy on Cisco Intersight. Remove the sample
...
virtual_media_policy_description = "A Cisco Intersight Virtual Media Policy generated by the Virtual Media Policy Maker."
virtual_media_policy_organization = "default"
...
def main():
    ...
    maker_type = "Intersight Virtual Media Policy Maker"
    ...
    virtual_media_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=virtual_media_policy_name,
        enable_virtual_media=enable_virtual_media,
        enable_virtual_media_encryption=enable_virtual_media_encryption,
        enable_low_power_usb=enable_low_power_usb,
        virtual_media_mapping_list=virtual_media_mapping_list,
        policy_description=virtual_media_policy_description,
        organization=virtual_media_policy_organization,
        intersight_base_url=intersight_base_url,
