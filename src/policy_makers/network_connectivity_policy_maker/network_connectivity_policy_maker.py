"""
Network Connectivity Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Network Connectivity Policy Maker for Cisco Intersight automates
         the creation of Network Connectivity Policies.
...
Network Connectivity Policy on Cisco Intersight. Remove the sample
...
network_connectivity_policy_description = "A Cisco Intersight Network Connectivity Policy generated by the Network Connectivity Policy Maker."
network_connectivity_policy_organization = "default"
...
def main():
    ...
    maker_type = "Intersight Network Connectivity Policy Maker"
    ...
    network_connectivity_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=network_connectivity_policy_name,
        preferred_ipv4_dns_server=preferred_ipv4_dns_server,
        alternate_ipv4_dns_server=alternate_ipv4_dns_server,
        obtain_ipv4_dns_server_from_dhcp=obtain_ipv4_dns_server_from_dhcp,
        enable_dynamic_dns=enable_dynamic_dns,
        ...
        organization=network_connectivity_policy_organization,
