"""
Switch Control Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Switch Control Policy Maker for Cisco Intersight automates
         the creation of Switch Control Policies.
...
Switch Control Policy on Cisco Intersight. Remove the sample
...
switch_control_policy_description = "A Cisco Intersight Switch Control Policy generated by the Switch Control Policy Maker."
switch_control_policy_organization = "default"
...
mac_address_table_aging_time_option = "Default"     # Options: "Default", "Custom", "Never"
...
def main():
    ...
    maker_type = "Intersight Switch Control Policy Maker"
    ...
    switch_control_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=switch_control_policy_name,
        enable_vlan_port_count_optimization=enable_vlan_port_count_optimization,
        mac_address_table_aging_time_option=mac_address_table_aging_time_option,
        mac_address_table_aging_time_custom_value_in_seconds=mac_address_table_aging_time_custom_value_in_seconds,
        link_control_message_interval_in_seconds=link_control_message_interval_in_seconds,
