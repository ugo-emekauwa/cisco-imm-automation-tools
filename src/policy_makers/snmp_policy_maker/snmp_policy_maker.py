"""
SNMP Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The SNMP Policy Maker for Cisco Intersight automates the creation
         of SNMP Policies in Intersight.
...
SNMP Policy on Cisco Intersight. Remove the sample
...
snmp_policy_description = "A Cisco Intersight SNMP Policy generated by the SNMP Policy Maker."
snmp_policy_organization = "default"
...
system_location = "Datacenter 001"
access_community_string = "demo_access_string"
snmp_community_access = "Disabled"      # Options: "Disabled", "Limited", "Full"
trap_community_string = "demo_trap_string"
snmp_engine_input_id = "0123456789ABC"
snmp_users_list = [
    {"Name": "demouser",
...
class SnmpPolicy(DirectlyAttachedUcsServerAndDomainPolicy):
...
def main():
    ...
    maker_type = "Intersight SNMP Policy Maker"
