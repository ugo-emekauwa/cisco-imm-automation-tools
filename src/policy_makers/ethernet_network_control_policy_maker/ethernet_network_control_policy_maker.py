"""
Ethernet Network Control Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Ethernet Network Control Policy Maker for Cisco Intersight
         automates the creation of Ethernet Network Control Policies.
...
Ethernet Network Control Policy on Cisco Intersight. Remove the sample
...
ethernet_network_control_policy_description = "A Cisco Intersight Ethernet Network Control Policy generated by the Ethernet Network Control Policy Maker."
ethernet_network_control_policy_organization = "default"
...
enable_cdp = False
mac_register_mode = "Only Native VLAN"        # Options: "Only Native VLAN", "All Host VLANs"
action_on_uplink_fail = "Link Down"      # Options: "Link Down", "Warning"
mac_forging = "Allow"        # Options: "Allow", "Deny"
...
def main():
    ...
    maker_type = "Intersight Ethernet Network Control Policy Maker"
    ...
    ethernet_network_control_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=ethernet_network_control_policy_name,
        enable_cdp=enable_cdp,
        mac_register_mode=mac_register_mode,
        action_on_uplink_fail=action_on_uplink_fail,
        mac_forging=mac_forging,
