"""
Link Control Policy Maker for Cisco Intersight, v2.0
Author: Ugo Emekauwa
Contact: uemekauw@cisco.com, uemekauwa@gmail.com
Summary: The Link Control Policy Maker for Cisco Intersight automates
         the creation of Link Control Policies.
...
Link Control Policy on Cisco Intersight. Remove the sample
...
link_control_policy_description = "A Cisco Intersight Link Control Policy generated by the Link Control Policy Maker."
link_control_policy_organization = "default"
...
admin_state = "Enabled"     # Options: "Enabled", "Disabled"
mode = "Normal"     # Options: "Normal", "Aggressive"
...
def main():
    ...
    maker_type = "Intersight Link Control Policy Maker"
    ...
    link_control_policy_maker(
        intersight_api_key_id=None,
        intersight_api_key=None,
        policy_name=link_control_policy_name,
        admin_state=admin_state,
        mode=mode,
